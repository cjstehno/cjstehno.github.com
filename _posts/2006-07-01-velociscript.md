...
I was toying with the idea of <a href="http://velocity.apache.org">velocity</a>-like expression evaluation and replacement on the client-side and I came up with this handy little JavaScript function:
...
It might be interesting to expand this a bit more to create a Velociscript object engine similar to Velocity itself so that templates can be managed and cached... we’ll see what happens when I start using this code.  
