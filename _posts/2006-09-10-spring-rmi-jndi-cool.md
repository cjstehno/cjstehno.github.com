...
I started looking into RMI again; it’s been a while since I have used it directly and as often happens, I got sidetracked. I found out how easy it is very to setup an RMI registry with <a href="http://springframework.org">Spring</a> and then access the bound objects via JNDI.
